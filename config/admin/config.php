<?php
// HTTP
define('HTTP_SERVER', 'localhost/admin/');
define('HTTP_CATALOG', 'localhost');

// HTTPS
define('HTTPS_SERVER', 'localhost/admin/');
define('HTTPS_CATALOG', 'localhost');
...
define('DB_USERNAME', 'secu');
define('DB_PASSWORD', 'secu');
define('DB_DATABASE', 'secu');
define('DB_PORT', '3306');
define('DB_PREFIX', '');